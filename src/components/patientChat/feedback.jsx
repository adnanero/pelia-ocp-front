...
import InputIcone from './../Inputs/InputIcone/index';
...
const Emoticones =( props ) =>
{
    ...
    return(
        <svg width="100%" height="100%" viewBox="0 0 50 50">
            ...
            <path d={organes.mounths[props.element]} className="mouth" fill={props.organe}></path>
            <path d={organes.rightEyes[props.element]} className="right-eye" fill={props.organe}></path>
            <path d={organes.leftEyes[props.element]} className="left-eye" fill={props.organe}></path>
        </svg>
    )
}
...
const Repeat =(props) => {
    ...
    return (
        <div className={props.addClass}>
            {items}
            <div className="current-rating" style={{transform:`translateX(${props.newRating * 100}%)`}}>
                <div className="svg-wrapper">
                    <Emoticones element={props.newRating} 
                        color={colors.visage[props.newRating]} 
                        organe="#655F52"  
                    />
                </div>
...
const SectionRepeat =(props) => {
    return(
      <Repeat numTimes={5} addClass="rating-control" newRating={props.newRating}>
        {(index) => 
        <div key={index} className="rating-option" onClick={ () => props.setNewRating(index)} >
            <div className="icon">
                <Emoticones
                    element={index} 
                    color="#8B959A"
            ...
            <div className="label" style={ (props.newRating === index) ? {transform:`translateY(10px)`,  color: "rgb(49, 59, 63)"} : {transform:`translateX(0px)`}} >
                {labels[index]}
            </div>
            <div className="touch-marker"></div>
        </div>
 ...
 const Feedback = (props) => {
  ...
  const handleSubmit = (e) => {
    ...
    return (
        <Col lg={{span:4, offset: 4}} md={{span:"8", offset: "2"}} xs="12">
             <Collapse in={!isSend}>
